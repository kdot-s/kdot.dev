...
function initMedia() {
  ...
  backgroundMusic.src = `assets/background_music0.mp3{Math.floor(Math.random() * 3)}.mp3`;
  if (!backgroundMusic) { 
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const bioMessages = [
    ...
    "Whats a type writer",
    "ima throw my cat at you",
    "G4 abusing me :(",

    "Momkey is a cool guy",
    "Zeus congrats on aac",

    "",
    "Hi Momkey ik you see this"
  ];
  let bioText = '';
  let bioIndex = 0;
